...
public class ExcelReaderN {
	/*
	Identify Testcases
	coloum by
	scanning the entire 1st row
	...
	public ArrayList<String> getData(String testcaseName) throws IOException {
		...
		FileInputStream fis = new FileInputStream("C:\\Users\\Anu\\Ecommercenew\\com.qa.ecommerce\\src\\main\\java\\com\\ecommerce\\testdata\\TestData.xlsx");
